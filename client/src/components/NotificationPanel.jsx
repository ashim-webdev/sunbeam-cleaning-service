      ...
      <Popover className='relative flex justify-center item-center'>
        <Popover.Button className='inline-flex items-center outline-none'>
          <div className={`
            ...
            {data?.length > 0 ? (
              <span className='absolute flex justify-center items-center text-center -top-3 right-0 text-sm text-white font-semibold w-7 h-7 rounded-full bg-red-600'>
                <span>{data.length > 99 ? "99+" : data.length}</span>
              </span>
            ) : null}
          </div>
        </Popover.Button>
